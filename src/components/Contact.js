...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 md:py-36 relative overflow-hidden bg-bg-main select-none">
      ...
      <div className="section-container">
        ...
        <div className="mb-20 max-w-3xl text-left">
          ...
          <p className="mt-4 text-sm md:text-base text-text-muted leading-relaxed">
            Whether you are looking to hire a full-stack developer, collaborate on a React interface, or simply say hi, my inbox is always open.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              ...
              <AnimatePresence mode="wait">
                {!submitted ? (
                  ...
                  >
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-text-muted block px-1">Your Name</label>
                        <input 
                          type="text" 
                          name="name"
                          required
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-text-muted block px-1">Email Address</label>
                        <input 
                          type="email" 
                          name="email"
                          required
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-text-muted block px-1">Your Message</label>
                      <textarea 
                        name="message"
                        rows="5"
                        required
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      <h3 className="text-xl font-black text-text-main uppercase">Message Sent</h3>
                      <p className="text-xs text-text-muted max-w-sm mx-auto leading-relaxed">
                        Thank you for reaching out! I will check your message and get back to you within 24 hours.
                      </p>
                    </div>
                  </motion.div>
                )}
          ...
          <div className="lg:col-span-5 space-y-8 w-full text-left">
            ...
            <div className="glass-panel p-8 border-border-main rounded-2xl space-y-6">
              <h4 className="text-[10px] font-black uppercase tracking-widest text-primary">Direct Channels</h4>
              
              <div className="space-y-5">
                <a href="mailto:hello@mehedihasan.dev" className="flex items-center space-x-4 group cursor-pointer">
                  ...
                  <div>
                    <h5 className="text-[8px] font-black text-text-muted uppercase tracking-wider">Email Direct</h5>
                    <p className="text-xs font-bold text-text-main group-hover:text-primary transition-colors">hello@mehedihasan.dev</p>
                  </div>
                </a>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h5 className="text-[8px] font-black text-text-muted uppercase tracking-wider">Base Location</h5>
                    <p className="text-xs font-bold text-text-main">Dhaka, Bangladesh (GMT+6)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel p-8 border-border-main rounded-2xl space-y-5 select-none">
              <div className="space-y-1">
                <h4 className="text-[10px] font-black uppercase tracking-widest text-primary">Let's Connect</h4>
                <p className="text-xs text-text-muted leading-relaxed">
                  I am regularly active on my professional networks. Let's connect, share developer notes, and discuss modern web design!
                </p>
              </div>

              <div className="flex space-x-4 pt-2">
                <a href="#" className="w-10 h-10 rounded-xl bg-bg-card border border-border-main flex items-center justify-center text-text-muted hover:text-primary transition-all duration-300 hover:scale-105">
                  <Github size={18} />
                </a>
                <a href="#" className="w-10 h-10 rounded-xl bg-bg-card border border-border-main flex items-center justify-center text-text-muted hover:text-primary transition-all duration-300 hover:scale-105">
                  <Linkedin size={18} />
